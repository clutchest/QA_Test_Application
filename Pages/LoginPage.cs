...
namespace TestAssignment.Pages
{
    public class LoginPage : BasePage
    {
        ...
        public ILocator ForgotPasswordLink => Page.GetByRole(AriaRole.Link, new() { Name = "Forgot Password?" }); public ILocator CreateNewAccountLink => Page.GetByRole(AriaRole.Link, new() { Name = "Create New Account" });
        public ILocator LoginMessage => Page.Locator("#loginMessage");

        public async Task GoTo() => await GoToLogin();
        ...
        public async Task VerifyLoginPageDisplayed()
        {
