...
namespace TestAssignment
{
    public class BasePage
    {
        ...
        const string BaseUrl = "https://qa-test-web-app.vercel.app/";
        ...
        public async Task GoToLogin() => await Page.GotoAsync(LoginUrl);
        public async Task GoToRegister() => await Page.GotoAsync(RegisterUrl);
        public async Task GoToDashboard() => await Page.GotoAsync(DashboardUrl);
    }
}
